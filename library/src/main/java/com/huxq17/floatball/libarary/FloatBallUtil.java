...
public class FloatBallUtil {
    ...
    public static RelativeLayout.LayoutParams getLayoutParams(Context context, boolean listenBackEvent) {
...
//        layoutParams.height = WindowManager.LayoutParams.WRAP_CONTENT;
    ...
    public static RelativeLayout.LayoutParams getStatusBarLayoutParams(Context context) {
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams( RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
